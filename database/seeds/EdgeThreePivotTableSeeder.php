...
class EdgeThreePivotTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::table('edge_three_pivot')->truncate();
        ...
        $pivots = [
            ...
            [ 'pattern_accordance_id' => 2, 'edge_category_id' => 6 ],
            [ 'pattern_accordance_id' => 3, 'edge_category_id' => 6 ],
        ];

        foreach ($pivots as $pivot){
            DB::table('edge_three_pivot')->insert([
